...
LengdAldur <- ggplot(jt, aes(x = aldur, y = le)) + geom_point() + geom_point(data = Medal, aes(x = aldur, y = avgle), col = "red")+ylab("Lengd") + xlab("Aldur")
KassaLengd <- ggplot(jt, aes(group = aldur, x = aldur, y = le)) + geom_boxplot() + ylab("Lengd") + xlab("Aldur")
